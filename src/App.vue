        ...
        data() {
            return {
                ...
                menu: [{
                    ...
                    {
                        label: 'About The Krewe',
                        icon: '',
                        to: '/aboutthekrewe'
                    },
                    {
                        label: 'Billy Bowlegs Festival',
                        icon: '',
                        to: '/billy-bowlegs-festival'
                    },
                    {
                        label: 'Krewe History',
                        icon: '',
                        items: [{
                                label: 'History of Bowlegs',
                                icon: '',
                                to: '/krewehistory'
                            },
                            {
                                label: 'Bowlegs Treasure Coins',
                                icon: '',
                                to: '/treasurecoins'
                            },
                            {
                                label: 'Coronation Programs',
                                icon: '',
                                to: '/coronationprograms'
                            },
                            {
                                label: 'Historic Pamphlets',
                                icon: '',
                                to: '/historicpamphlets'
                            },
                            {
                                label: 'Historic Videos',
                                icon: '',
                                to: '/historicvideos'
                            },
                            {
                                label: 'Society of Bowlegs',
                                icon: '',
                                to: '/societyofbowlegs'
                            },
                            {
                                label: 'William Bowles',
                                icon: '',
                                to: '/williamaugustusbowles'
                            },
